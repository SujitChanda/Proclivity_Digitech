      ...
      child: Padding(
        ...
        child: new Card(
          ...
          shape: new RoundedRectangleBorder(
            side: BorderSide(
                color: Theme.of(context).colorScheme.primaryVariant, width: 0.5),
                  ...
                  new Container(
                      ...
                      child: Padding(
                        ...
                        textAlign: TextAlign.center,
                            ...
                            softWrap: false,
                            style: Theme.of(context).textTheme.bodyText2.copyWith(color: Colors.white, fontWeight: FontWeight.normal )),
                      ))
                ],
              ),
              new Material(
